...
<style>
    ...
    line-height: 32px; border-radius:20px; float:left; cursor:pointer; color:#fff; margin-left:-15px;}
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
	                ...
	                <div class="btn_fr">
	                    <input type="checkbox" id="ck_item2" name="ck_item"> <label for="ck_item1">약관의 동의</label><br><br>
